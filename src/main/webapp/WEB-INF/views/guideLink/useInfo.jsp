...
<!-- 안내바 S -->
  <div id="expath" class="path">
   <ol>
    ...
    <li>
     <a href="#"><strong>이용안내</strong></a>
    </li>
   </ol>
  </div>
<!-- 안내바 E -->

  <div class="guideLink_title">이용안내</div>
  <div class="guideMenu">
   <ul class="menucategory">
    <li><a href="guideLink_useTerms">이용약관</a></li>
    <li><a href="guideLink_privacyManage">개인정보취급방침</a></li>
    <li><a href="guideLink_useInfo"><strong style="color: #222;">이용안내</strong></a></li>  
   </ul>
  </div>

  <div class="mall-faq">
   <div class="useInfo_category" style="padding-top: 150px; margin-top: -150px;">
    <table class="useInfo_table" id="member">
     <tr>
      <td class="useInfo_categorychoice"><a href="#member">회원가입 안내</a></td>
      <td ><a href="#order">주문 안내</a></td>
      <td ><a href="#payment">결제 안내</a></td>
      <td ><a href="#delivery">배송 안내</a></td>
      <td ><a href="#change">교환/반품 안내</a></td>
      <td ><a href="#refund">환불 안내</a></td>
      <td ><a href="#etc">기타 안내</a></td>
     </tr> 
    </table>
    <div class="cont">
     <h3>회원가입 안내</h3><br>
   ...
   <div class="useInfo_category" style="padding-top: 150px; margin-top: -150px;">
    <table class="useInfo_table" id="order">
     <tr>
      <td ><a href="#member">회원가입 안내</a></td>
      <td class="useInfo_categorychoice"><a href="#order">주문 안내</a></td>
      <td ><a href="#payment">결제 안내</a></td>
      <td ><a href="#delivery">배송 안내</a></td>
      <td ><a href="#change">교환/반품 안내</a></td>
      <td ><a href="#refund">환불 안내</a></td>
   ...
   <div class="useInfo_category" style="padding-top: 150px; margin-top: -150px;">
    <table class="useInfo_table" id="payment">
     <tr>
      <td ><a href="#member">회원가입 안내</a></td>
      <td ><a href="#order">주문 안내</a></td>
      <td class="useInfo_categorychoice"><a href="#payment">결제 안내</a></td>
      <td ><a href="#delivery">배송 안내</a></td>
      <td ><a href="#change">교환/반품 안내</a></td>
      <td ><a href="#refund">환불 안내</a></td>
      <td ><a href="#etc">기타 안내</a></td>
   ...
   <div class="useInfo_category" style="padding-top: 150px; margin-top: -150px;">
    <table class="useInfo_table" id="delivery">
     <tr>
      <td ><a href="#member">회원가입 안내</a></td>
      <td ><a href="#order">주문 안내</a></td>
      <td ><a href="#payment">결제 안내</a></td>
      <td class="useInfo_categorychoice"><a href="#delivery">배송 안내</a></td>
      <td ><a href="#change">교환/반품 안내</a></td>
      <td ><a href="#refund">환불 안내</a></td>
      <td ><a href="#etc">기타 안내</a></td>
     </tr>
	...
	배송 방법 : 택배<br>
	배송 지역 : 전국지역<br>
	배송 비용 : 조건부 무료 : 주문금액 50,000원 미만일 때 배송비 3,000원을 추가합니다.<br>
	배송 기간 : 1일 ~ 7일<br>
	배송 안내 : <br><br>
   ...
   <div class="useInfo_category" style="padding-top: 150px; margin-top: -150px;">
    <table class="useInfo_table" id="change">
     <tr class="row">
      <td ><a href="#member">회원가입 안내</a></td>
      <td ><a href="#order">주문 안내</a></td>
      <td ><a href="#payment">결제 안내</a></td>
      <td ><a href="#delivery">배송 안내</a></td>
      <td class="useInfo_categorychoice"><a href="#change">교환/반품 안내</a></td>
      <td ><a href="#refund">환불 안내</a></td>
      <td ><a href="#etc">기타 안내</a></td>
     </tr>
    </table>
    <div class="cont">
   	...
   	- 서울특별시 강남구 강남대로 101번길 캠핑빌딩 12F<br><br>
   ...
   <div class="useInfo_category" style="padding-top: 150px; margin-top: -150px;">
    <table class="useInfo_table" id="refund">
     <tr>
      <td ><a href="#member">회원가입 안내</a></td>
      <td ><a href="#order">주문 안내</a></td>
      <td ><a href="#payment">결제 안내</a></td>
      <td ><a href="#delivery">배송 안내</a></td>
      <td ><a href="#change">교환/반품 안내</a></td>
      <td class="useInfo_categorychoice"><a href="#refund">환불 안내</a></td>
      <td ><a href="#etc">기타 안내</a></td>
     </tr>
    </table>
    <div class="cont">
   ...
   <div class="useInfo_category" style="padding-top: 150px; margin-top: -150px;">
    <table class="useInfo_table" id="etc">
     <tr>
      <td ><a href="#member">회원가입 안내</a></td>
      <td ><a href="#order">주문 안내</a></td>
      <td ><a href="#payment">결제 안내</a></td>
      ...
      <td ><a href="#change">교환/반품 안내</a></td>
      <td ><a href="#refund">환불 안내</a></td>
      <td class="useInfo_categorychoice"><a href="#etc">기타 안내</a></td>
     </tr>
    </table>
    <div class="cont">
   	<h3>기타 안내</h3><br>
	...
	20일 동안은 미가용 적립금으로 분류 됩니다. 미가용 적립금은 반품, 구매취소 등을 대비한 실질적인 구입이 되지 않은 주문의 적립금 입니다.<br>
	사용가능한 적립금(총 적립금-사용된적립금-미가용적립금)은 상품구매시 즉시 사용하실 수 있습니다.<br><br>
	
	<b>이용조건</b><br>
	적립금사용시 최소구매가능적립금(구매가능한 적립금 요구선)은 0원 입니다. 적립금 사용시 최대구매가능적립금(적립금 1회 사용 가능 최대금액)은 '한도제한없음' 입니다.<br><br>

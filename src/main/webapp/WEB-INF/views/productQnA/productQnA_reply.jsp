...
<%--댓글 창(답변 창) 구역--%>
<div id="bReply_wrap">
<form method="post" action="productQnA_reply_ok?page=${page}" onsubmit="return replycont_btn_check()">
...
<div class="okcancellist_btn">
 ...
 <input class="product_QnA_btn" type="button" value="취소" onclick="location='productQnA_view?board_no=${prov.board_no}&page=${page}&state=view';">
</div>

...
<form method="post" action="/review_write_ok" onsubmit="return okcancellist_btn_check();" enctype="multipart/form-data">
 ...
 <table id="bCont_t">
  ...
  <tr>
   <th class="proQnAth" scope="row">상품 사진 </th>
    <td><input type="file" name="board_file1"></td> 
   </tr>
   
  <%-- 
  <tr>
   <th>상품 사진 2</th>
    <td><input type="file" name="mem_file2" ></td> 
  </tr>
  <tr>
   <th>상품 사진 3</th>
    <td><input type="file" name="mem_file3" ></td> 
  </tr>
  --%>
  </table>
<div class="okcancellist_btn"> 
   ...
   <input class="product_QnA_btn" type="button" value="목록" 
